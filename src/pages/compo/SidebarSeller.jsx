  ...
  return (
    <aside className="w-[280px] bg-white h-screen flex flex-col border-r border-gray-200">
      ...
      <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
        ...
        />
        <NavItem
          add={"/seller/dashboard/chat"}
          icon={MessageSquare}
          label="Chats"
          badge={1}
          isActive={location.pathname === "/seller/dashboard/chat"}
        />
        <NavItem
          add={"/seller/dashboard/agents"}
          icon={Users}
          label="My Agents"
          isActive={location.pathname === "/seller/dashboard/agents"}
        />
        <NavItem
          add={"/seller/dashboard/add-agent"}
          icon={SquarePlus}
          label="My Agents"
          isActive={location.pathname === "/seller/dashboard/add-agent"}
        />
        <NavItem
          add={"/seller/dashboard/profile"}
          icon={User}
          label="My Profile"
          isActive={location.pathname === "/seller/dashboard/profile"}
        />
      </nav>
