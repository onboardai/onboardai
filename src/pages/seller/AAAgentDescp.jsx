...
import { get_agent_profile, get_agent_profile_seller } from "../../store/Reducers/agentReducer";
...
const AAAgentDescp = () => {
  ...
  useEffect(() => {
    dispatch(get_agent_profile_seller(agentId));
  }, [agentId]);
